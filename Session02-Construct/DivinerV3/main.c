...
int main(int argc, char *argv[]) {
	...
	//coi A và a đều là a nói chung, A nói chung đâu có soa
	//ta chỉ cần so sánh fL với A là đủ, nếu gõ a thường ta convert
	//thành A hoa luôn
	
	if (fL >= 'a' && fL <= 'z') //có đúng là bạn nhập chữ cái thường hok
							   //đúng là fL từ a ... z thường hay ko
							   //thì convert thành HOA		
							   //đúng thường thì convert thành hoa
		fL -= 32;
